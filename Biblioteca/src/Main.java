    ...
    public static void main(String[] args) {
        ...
        switch(i) {
            case 1:
                ...
                System.out.println("Añadir nuevo usuario desde Bbiblioteca");
            ...
            case 2:
                ...
                Libro listaLibros = new Libro(isbn,nombrelibro,autor);
                break;
            case 3:
//Seguir aqui, que busque el ISBN si no se encuentra y comprobar si prestado es =false
            ...
            case 4:
                ...
                do {
                    System.out.print("-Introduce el ISBN, 0 para salir: ");
